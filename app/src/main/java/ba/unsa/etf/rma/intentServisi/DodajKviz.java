...
public class DodajKviz extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (jeLiDuplikat(token)) {
            ...
            URL url = null;
            try {
                String u = "https://firestore.googleapis.com/v1/projects/rmaspirala/databases/(default)/documents/Kvizovi?";
                url = new URL(u);
