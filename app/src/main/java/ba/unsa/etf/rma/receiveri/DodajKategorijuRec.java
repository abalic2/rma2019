...
public class DodajKategorijuRec extends ResultReceiver {
    private Receiver mReceiver;

    public DodajKategorijuRec(Handler handler) {
        super(handler);
    }
    ...
    protected void onReceiveResult(int resultCode, Bundle resultData) {
        if (mReceiver != null) {
            mReceiver.onReceiveResultNovaKategorija(resultCode, resultData);
        }
    }
}