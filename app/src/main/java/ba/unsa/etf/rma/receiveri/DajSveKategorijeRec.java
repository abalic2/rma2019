...
public class DajSveKategorijeRec extends ResultReceiver {
    private Receiver mReceiver;

    public DajSveKategorijeRec(Handler handler) {
        super(handler);
    }
    ...
    protected void onReceiveResult(int resultCode, Bundle resultData) {
        if (mReceiver != null) {
            mReceiver.onReceiveResultKategorije(resultCode, resultData);
        }
    }
}